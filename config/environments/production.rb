...
Rails.application.configure do
  ...
  # Allow cookies to be used across domains (frontend + backend on Render)
  config.action_dispatch.cookies_same_site_protection = :none

  # Force SSL so cookies can be Secure=true (required by Chrome for cross-site cookies)
  ...
  # Allow all *.onrender.com hostnames
